...
st.write("  ")
t1,t2,t3= st.columns([0.9,0.15,0.08])
# with t1:
#      st.markdown(
#                 """
#                 <div style="display: flex; text-align: left;">
#                 <h2 style="color:  #171719;size:30px; ">Smart Pricing</h2>
#                 </div>
#                 """,
#                 unsafe_allow_html=True
#                 )
with t2:
    on = st.toggle('Optimal Promotion')
if on:
    with t3:
        with stylable_container(
                                    key="green_button_sp1",
                                    css_styles="""
                                        button {
            ...
            if st.button('Glossary', key=10003, use_container_width=True):
    ...
    with t3:
        with stylable_container(
            ...
            if st.button('Glossary', key=1004, use_container_width=True):
